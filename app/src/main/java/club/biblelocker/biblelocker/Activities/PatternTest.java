...
public class PatternTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPatternLockView = (PatternLockView) findViewById(R.id.patter_lock_testt);
                    ...
                    public void accept(PatternLockCompoundEvent event) throws Exception {
                        if (event.getEventType() == PatternLockCompoundEvent.EventType.PATTERN_STARTED) {
                            ...
                            if (nowpattern.equals(check_patternpass())) {
                                pattern_check = true;
                                Toast.makeText(PatternTest.this, "맞는 패턴 이에용", Toast.LENGTH_SHORT).show();
                            } else {
                                mPatternLockView.setViewMode(PatternLockView.PatternViewMode.WRONG);
                                pattern_check = false;
                                Toast.makeText(PatternTest.this, "틀렸어용...", Toast.LENGTH_SHORT).show();
